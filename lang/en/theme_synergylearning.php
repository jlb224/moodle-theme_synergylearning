...
$string['choosereadme'] = 'SynergyLearning is a child theme of Boost.';
$string['configtitle'] = 'SynergyLearning';
$string['copyright'] = 'Copyright';
$string['copyright_desc'] = 'The copyright text. The copyright symbol (©) will be prepended to text added here.';
$string['footerlogo'] = 'Footer logo';
$string['footerlogo_desc'] = 'The footer logo.';
...
$string['privacy:metadata'] = 'The SynergyLearning theme does not store any personal data about any user.';
